...
import {createContest, getContests, getActiveContests, getContestById,
    getContestsByType, getContestsByStyle, getUserContests, proceedPay, updateContest, validateAuthor}
    from './controllers/contestControllers/contestControllers';
...
import {updateEntry, getUserEntries} from './controllers/entryController/entryController';
...
router.get('/contests/active', validateToken, getActiveContests);
...
router.put('/contests', validateToken, validateContest, validateAuthor, updateContest);
...
router.get('/entries/user', validateToken, getUserEntries);
